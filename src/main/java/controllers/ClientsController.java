...
import com.mycompany.umb.maven.ClientsFacade;
import com.mycompany.umb.maven.util.JsfUtil;
import com.mycompany.umb.maven.util.PaginationHelper;
...
public class ClientsController implements Serializable {
    ...
    @EJB
    private com.mycompany.umb.maven.ClientsFacade ejbFacade;
