...
@NamedQueries({
    ...
    @NamedQuery(name = "Clients.findByStatusClient", query = "SELECT c FROM Clients c WHERE c.statusClient = :statusClient")})
public class Clients implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.umb.maven.Clients[ id=" + id + " ]";
    }
